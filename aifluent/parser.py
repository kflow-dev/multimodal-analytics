...
- The custom parser registry is primarily intended for Python usage, where your
  ...
  before invoking AIFluent APIs.
- The standalone CLI (``python -m aifluent.parser`` or the installed console
...
def register_parser(name: str, parser_class: type) -> None:
    """Register a custom parser class for use with AIFluent.
    ...
    Example::
        ...
        from aifluent.parser import Parser, register_parser
...
def main():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Python process are also accepted when you integrate AIFluent "
