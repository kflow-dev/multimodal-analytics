"""
Query functionality for AIFluent
...
class QueryMixin:
    """QueryMixin class containing query functionality for AIFluent"""
        ...
        **kwargs,
        ...
        if not hasattr(self, "vision_model_func") or not self.vision_model_func:
            raise ValueError(
                ...
                "Please provide a vision model function when initializing AIFluent."
            )
