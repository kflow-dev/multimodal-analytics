"""
Utility functions for AIFluent
...
async def insert_text_content_with_multimodal_content(
    ...
    try:
        ...
        logger.info(
            "If the error is caused by the ainsert function not having a multimodal content parameter, please update the aifluent branch of lightrag"
        )
